...
$(document).ready(function(){      
    ...
    $('#sidebarCollapse').on('click', function() {
        $('#sidebar, #content').toggleClass('nvactive');
        console.log("click");
      }); 
	function init_template(){
        ...
        /*changmeng 2020 11 18 toggle the menu*/
        ...
        var menu = $('.menu'),
            ...
            headerAndContent = $('.page-content, #footer-bar'),
            /*headerAndContent = $('.header, .page-content, #footer-bar'), changmeng remove header */
        ...
        menuDeployer.on('click',function(){     
            ...
            /*changmeng add 2020 11 18 push scale*/
            if(menuEffect === "menu-push-scale"){
                let w = $(".page-content:first").width();
